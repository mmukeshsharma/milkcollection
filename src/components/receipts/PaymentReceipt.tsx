...
import { buildPaymentText, RECEIPT_FONT_FAMILY, type PrinterSettings } from '@/lib/printer-service'
...
export const PaymentReceipt: React.FC<Props> = ({ data, settings, locale = 'en', mode = 'print' }) => {
