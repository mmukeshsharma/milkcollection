...
import { buildSaleText, RECEIPT_FONT_FAMILY, type PrinterSettings } from '@/lib/printer-service'
...
export const MilkSaleReceipt: React.FC<Props> = ({ data, settings, locale = 'en', mode = 'print' }) => {
  const text = buildSaleText(data, settings, locale)
